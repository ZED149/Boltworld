...
from PDF_Automation.logging import Logging
import os
...
if __name__ == "__main__":
    ...
    # Logging
    logger = Logging(logger_name="Salman", logger_directory='.')
    logger.verbose = False

    # Excel Handler
    excel_handler = ExcelHandler(logger=logger, filename="boltworld.xlsx")
    # GUI component
